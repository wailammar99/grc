    ...
    <form action= "{{url('home/opportunite/'.$opportunités->id)}}" method="POST">
        ...
        <label for="firstName" class="fl fontLabel"> Name: </label>
          ...
          <i class="fa fa-user" aria-hidden="true"></i>
              ...
              <div class="fr">
                      <input type="text" name="nom" value="{{$opportunités->nom}}"
      ...
      <!--Second name-->
        ...
        <label for="secondName" class="fl fontLabel"> Montant: </label>
              ...
              <div class="fr">
                      <input type="text" name="montant" value="{{$opportunités->montant}}"
          ...
          <div class="box">
            <label for="secondName" class="fl fontLabel"> Etape: </label>
                  <div class="fl iconBox"><i class="fa fa-user" aria-hidden="true"></i></div>
                  <div class="fr">
                          <input type="text" name="etape" value="{{$opportunités->etape}}"
                  ...
                  <div class="clr"></div>
                      ...
                      <div class="box">
                        <label for="secondName" class="fl fontLabel"> Date de cloture: </label>
                              <div class="fl iconBox"><i class="fa fa-user" aria-hidden="true"></i></div>
                              <div class="fr">
                                      <input  type="date" name="date_de_cloture" value="{{$opportunités->date_de_cloture}}"
          ...
          <!---Phone No.------>
          <div class="box">
        <label for="phone" class="fl fontLabel"> Client : </label>
              <div class="fl iconBox"><i class="fa fa-phone-square" aria-hidden="true"></i></div>
              <div class="fr">
                      <input  type="text" name="client" value="{{$opportunités->client}}" placeholder="Phone No." class="textBox">
              </div>
              <div class="clr"></div>
          </div>
          <!---Phone No.---->
        ...
        <label for="email" class="fl fontLabel"> Produits: </label>
              ...
              <div class="fr">
                      <input type="text" name="produits" value="{{$opportunités->produits}}" class="textBox">
              </div>
              <div class="clr"></div>
          </div>
          <!--Email ID----->
