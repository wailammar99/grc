    ...
    <form action= "{{url('home/prospect/'. $prospect->id)}}" method="POST">
        ...
        <label for="firstName" class="fl fontLabel"> Name: </label>
          ...
          <i class="fa fa-user" aria-hidden="true"></i>
              ...
              <div class="fr">
                      <input  type="text" name="nom" value="{{$prospect->nom}}"
      ...
      <!--Second name-->
        ...
        <label for="secondName" class="fl fontLabel"> Last Name: </label>
              ...
              <div class="fr">
                      <input type="text" name="prenom" value="{{$prospect->prenom}}"
          ...
          <div class="box">
            <label for="secondName" class="fl fontLabel"> Societe: </label>
                  <div class="fl iconBox"><i class="fa fa-user" aria-hidden="true"></i></div>
                  <div class="fr">
                          <input  type="text" name="societe" value="{{$prospect->societe}}"
                  ...
                  <div class="clr"></div>
                      ...
                      <div class="box">
                        <label for="secondName" class="fl fontLabel"> Telephone: </label>
                              <div class="fl iconBox"><i class="fa fa-user" aria-hidden="true"></i></div>
                              <div class="fr">
                                      <input  type="text" name="telephone" value="{{$prospect->telephone}}"
        ...
        <label for="phone" class="fl fontLabel"> Adresse : </label>
              ...
              <div class="fr">
                      <input  type="text" name="adresse" value="{{$prospect->adresse}}" placeholder="Phone No." class="textBox">
              </div>
              <div class="clr"></div>
          </div>
          <!---Phone No.---->
        ...
        <label for="email" class="fl fontLabel"> Site web: </label>
              ...
              <div class="fr">
                      <input   type="text" name="site_web" value="{{$prospect->site_web}}" class="textBox">
              </div>
              <div class="clr"></div>
          </div>
          <!--Email ID----->
          <div class="box">
            <label for="email" class="fl fontLabel"> Source: </label>
                  <div class="fl iconBox"><i class="fa fa-envelope" aria-hidden="true"></i></div>
                  <div class="fr">
                          <input type="text" name="source" value="{{$prospect->source}}" class="textBox">
                  </div>
                  <div class="clr"></div>
              </div>
              <div class="box">
                <label for="email" class="fl fontLabel"> Email: </label>
                      <div class="fl iconBox"><i class="fa fa-envelope" aria-hidden="true"></i></div>
                      <div class="fr">
                              <input type="text" name="email" value="{{$prospect->email}}" class="textBox">
                      </div>
                      <div class="clr"></div>
                  </div>
          <!---Password------>
